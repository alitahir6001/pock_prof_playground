...
- [x] `docs/phase3_adaptation_engine_build_slice.md`
- [x] `docs/phase3_broker_telemetry_slice.md`

## Operational runbooks / support docs
- [x] `backend/docs/adaptation_evaluations_migration_runbook.md`
- [x] `backend/docs/adaptation_troubleshooting_guide.md`
- [x] `docs/code_breakdown_plan.md`
